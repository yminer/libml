...
*)
val float_array_of_string : string -> float array
...
*)
val string_of_float_array : float array -> string
...
(**
  ...
  @return The corresponding string.
*)
val string_of_float_array_array : float array array -> string

(**
  Converts a float array array array to a string.
  @return The corresponding string.
*)
val string_of_float_array_array_array : float array array array -> string
