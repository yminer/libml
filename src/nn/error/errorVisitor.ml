...
(**
  The errorVisitor virtual class
...
(**
  The abstract error visitor.
  Instances of derived classes are supposed to compute the output error of
  various kinds of neural networks.
*)
class virtual ['a] errorVisitor =
object
